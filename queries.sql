...
-- Edit our remaining column names and confirm types
...
ALTER TABLE CricketStats..TestInnings20thCentury
ALTER COLUMN Runs_Scored VARCHAR(50)
ALTER TABLE CricketStats..TestInnings21stCentury
ALTER COLUMN Runs_Scored VARCHAR(50)
...
ALTER TABLE CricketStats..TestInnings20thCentury
ALTER COLUMN Minutes_Batted VARCHAR(50)
ALTER TABLE CricketStats..TestInnings21stCentury
ALTER COLUMN Minutes_Batted VARCHAR(50)
...
ALTER TABLE CricketStats..TestInnings20thCentury
ALTER COLUMN Not_Out VARCHAR(10)
ALTER TABLE CricketStats..TestInnings21stCentury
ALTER COLUMN Not_Out VARCHAR(10)
...
ALTER TABLE CricketStats..TestInnings20thCentury
ALTER COLUMN Balls_Faced VARCHAR(10)
ALTER TABLE CricketStats..TestInnings21stCentury
ALTER COLUMN Balls_Faced VARCHAR(10)
...
ALTER TABLE CricketStats..TestInnings20thCentury
ALTER COLUMN Batting_Strike_Rate VARCHAR(20)
ALTER TABLE CricketStats..TestInnings21stCentury
ALTER COLUMN Batting_Strike_Rate VARCHAR(20)
...
ALTER TABLE CricketStats..TestInnings20thCentury
ALTER COLUMN Innings_No VARCHAR(10)
ALTER TABLE CricketStats..TestInnings21stCentury
ALTER COLUMN Innings_No VARCHAR(10)
